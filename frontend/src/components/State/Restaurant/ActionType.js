...
export const DELETE_RESTAURANT_REQUEST = "GET_ALL_RESTAURANT_REQUEST";
export const DELETE_RESTAURANT_SUCCESS = "GET_ALL_RESTAURANT_SUCCESS";
export const DELETE_RESTAURANT_FAILURE = "GET_ALL_RESTAURANT_FAILURE";

export const UPDATE_RESTAURANT_REQUEST = "GET_ALL_RESTAURANT_REQUEST";
export const UPDATE_RESTAURANT_FAILURE = "GET_ALL_RESTAURANT_FAILURE";
export const UPDATE_RESTAURANT_SUCCESS = "GET_ALL_RESTAURANT_SUCCESS";
...
export const UPDATE_RESTAURANT_STATUS_SUCCCESS = "UPDATE_RESTAURANT_STATUS_SUCCCESS";
export const UPDATE_RESTAURANT_STATUS_FAILURE = "UPDATE_RESTAURANT_STATUS_FAILURE";

export const CREATE_EVENTS_REQUEST = "export const CREATE_EVENTS_REQUEST";
export const CREATE_EVENTS_SUCCESS = "export const CREATE_EVENTS_SUCCESS";
export const CREATE_EVENTS_FAILURE = "export const CREATE_EVENTS_FAILURE";
