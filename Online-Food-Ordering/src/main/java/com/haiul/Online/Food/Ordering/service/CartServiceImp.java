...
import com.haiul.Online.Food.Ordering.repository.CartItemRepository;
...
//    private FoodRepository foodRepository;
    ...
    public CartItem addItemToCart(AddCartItemResquest req, String jwt) throws Exception {
        ...
        CartItem savetCartItem = cartItemRepository.save(newCartItem);

        cart.getItem().add(savetCartItem);

        return savetCartItem;
    }
    ...
    public CartItem updateCartItemQuantity(Long cartItemId, int quantity) throws Exception {
        ...
        if(cartItemOptional.isEmpty()){
            throw new Exception("Cart irem is not found");
        }
